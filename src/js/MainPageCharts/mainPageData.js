 ...
 */
export function refreshDataForMainPage(){
    var snpData = getSNPData();
    var dataList = getDataFromFRED(fredDataTags);
    return snpData, dataList;
}

//This is must for historical S&P 500 data dating back 100 years ago. FRED only provides from 2013.

/**
 * @returns {{data1: Array<{date: string, value: number}>}}
 * returns historical S&P 500 data from NASDAQ DATA LINK.
 */ 
export function getSNPData(){
    axios.get('https://data.nasdaq.com/api/v3/datasets/MULTPL/SP500_REAL_PRICE_MONTH.json?',
    {
        params :{
 ...
 * @todo modifying params of API call from the client side
 */
export function getDataFromFRED(fredDataTags){
...
// function getDataFromOtherSources(){

// }


// export default getDataForMainPage;