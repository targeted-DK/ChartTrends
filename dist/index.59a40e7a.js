...
const axios = require("8298717190660ebc");
const getUser = async ()=>{
    const getResponse = await axios.get("https://jsonplaceholder.typicode.com/users/1").then((response)=>response).catch((err)=>console.log(err));
    return getResponse;
};
const postUser = async ()=>{
    const postResponse = await axios.post("https://jsonplaceholder.typicode.com/users", {
        id: 11,
        name: "Tom Brady",
        username: "Brad",
...
const concurrentRequests = async ()=>{
    const conResponse = await axios.all([
...
},{"8298717190660ebc":"jo6P5"}],"jo6P5":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7ZoMj","8lRBv"], "8lRBv", "parcelRequire30ab")
