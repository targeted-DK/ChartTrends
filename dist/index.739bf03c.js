...
var _mainDataListJs = require("../static/mainDataList.js");
 ...
 */ function fetchDatafromDatabase() {
    ...
    (0, _axiosDefault.default).get("http://localhost:3000/requests/mysqlRequest", {
        params: {
            data: "DGS10"
        }
    }).then((response)=>{
...
document.getElementById("category").addEventListener("click", function(event) {
    // event.preventDefault(); // Prevent the default behavior of the link
    console.log("test");
    fetch("/chart").then((response)=>response.text()).then((data)=>document.body.innerHTML = data).catch((error)=>console.error(error));
});
...
},{"axios":"jo6P5","../static/mainDataList.js":"2VWx8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2VWx8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gHDMI","ebWYT"], "ebWYT", "parcelRequire30ab")
